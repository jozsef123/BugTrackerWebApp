        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ticket_AspNetUsers_AssignedDeveloperId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppFile_AspNetUsers_SubmitterId",
                        column: x => x.SubmitterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppFile_Ticket_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_AspNetUsers_SubmitterId",
                        column: x => x.SubmitterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TicketId = table.Column<int>(type: "integer", nullable: false),
                    PreviousAssignedDeveloperId = table.Column<string>(type: "text", nullable: true),
                    NewAssignedDeveloperId = table.Column<string>(type: "text", nullable: true),
                    UpdatedWhen = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketHistory_AspNetUsers_NewAssignedDeveloperId",
                        column: x => x.NewAssignedDeveloperId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TicketHistory_AspNetUsers_PreviousAssignedDeveloperId",
                        column: x => x.PreviousAssignedDeveloperId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TicketHistory_AspNetUsers_UpdaterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppFile_SubmitterId",
                table: "AppFile",
                column: "SubmitterId");

            migrationBuilder.CreateIndex(
                name: "IX_AppFile_TicketId",
                table: "AppFile",
                column: "TicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ticket_AssignedDeveloperId",
                table: "Ticket",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistory_NewAssignedDeveloperId",
                table: "TicketHistory",
                column: "NewAssignedDeveloperId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketHistory_PreviousAssignedDeveloperId",
                table: "TicketHistory",
                column: "PreviousAssignedDeveloperId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistory_UpdaterId",
                table: "TicketHistory",
                column: "UpdaterId");
